...
public class GenerateShiftReportActivity extends AppCompatActivity {

    TableLayout tlSReport;
    String DriverShift;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_generate_shift_report);
        ...
        llSReport = (LinearLayout)findViewById(R.id.llSReport);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ContextCompat.checkSelfPermission(getApplicationContext(),
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(GenerateShiftReportActivity.this,
                            Manifest.permission.WRITE_EXTERNAL_STORAGE) && ActivityCompat.shouldShowRequestPermissionRationale(GenerateShiftReportActivity.this,
                            Manifest.permission.READ_EXTERNAL_STORAGE)) {
                        Log.d("size"," "+llSReport.getWidth() +"  "+llSReport.getWidth());
                        bitmap = loadBitmapFromView(llSReport, llSReport.getWidth(), llSReport.getHeight());
                        createPdf();
                    } else {
                        ActivityCompat.requestPermissions(GenerateShiftReportActivity.this, new String[]{"android.permission.WRITE_EXTERNAL_STORAGE", "android.permission.READ_EXTERNAL_STORAGE"}, 200);
        ...
        tlSReport = (TableLayout) findViewById(R.id.tlSReport);
    ...
    private void createPdf(){
        ...
        int hight = llSReport.getChildAt(0).getHeight();
        //float width = displaymetrics.widthPixels ;
        int width = llSReport.getChildAt(0).getWidth();
...
//        Bitmap bitmap = BitmapFactory.decodeResource(mResources, R.drawable.screenshot);
    ...
    private void addHeaders() {
        ...
        tlSReport.addView(tr1, getTblLayoutParams());
        ...
        tlSReport.addView(tr, getTblLayoutParams());
    }
    ...
    private void addData() {
        ...
        tlSReport.addView(tr2, getTblLayoutParams());
    }
