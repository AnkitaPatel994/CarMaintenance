...
public class ShiftReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spRSDriverShift = (Spinner)findViewById(R.id.spRSDriverShift);

        txtRSDate = (TextView)findViewById(R.id.txtRSDate);
        txtRSDate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                DatePickerDialog mDatePicker;
                mDatePicker = new DatePickerDialog(ShiftReportActivity.this,new DatePickerDialog.OnDateSetListener() {
                    public void onDateSet(DatePicker datepicker, int selectedyear, int selectedmonth, int selectedday) {
                        selectedmonth = selectedmonth + 1;

                        if(selectedmonth < 10 && selectedday < 10)
                        {
                            txtRSDate.setText(selectedyear + "-" + "0"+selectedmonth + "-" + "0"+selectedday);
                        }
                        else if(selectedmonth < 10)
                        {
                            txtRSDate.setText(selectedyear + "-" + "0"+selectedmonth + "-" + selectedday);
                        }
                        else if(selectedday < 10)
                        {
                            txtRSDate.setText(selectedyear + "-" + selectedmonth + "-" + "0"+selectedday);
                        }
                        else
                        {
                            txtRSDate.setText(selectedyear + "-" + selectedmonth + "-" + selectedday);
                        }
                    }
                }, mYear, mMonth, mDay);
        ...
        btnRSReport = (Button) findViewById(R.id.btnRSReport);
        btnRSReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(txtRSDate.getText().toString().equals(""))
                {
                    Toast.makeText(ShiftReportActivity.this,"Enter Date",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    GetShiftReport shiftReport = new GetShiftReport();
                    shiftReport.execute();
                }
            }
        });
    ...
    private class GetShiftReport extends AsyncTask<String,Void,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog=new ProgressDialog(ShiftReportActivity.this);
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                joUser.put("c_dshift",spRSDriverShift.getSelectedItem().toString());
                joUser.put("c_date",txtRSDate.getText().toString());
                Postdata postdata = new Postdata();
                String pdUser=postdata.post(MainActivity.BASE_URL+"shiftreport.php",joUser.toString());
        ...
        protected void onPostExecute(String s) {
            ...
            if(status.equals("1"))
            {
                Intent i = new Intent(ShiftReportActivity.this,GenerateShiftReportActivity.class);
                i.putExtra("DriverShift",spRSDriverShift.getSelectedItem().toString());
            ...
            {
                Toast.makeText(ShiftReportActivity.this,message,Toast.LENGTH_SHORT).show();
            }
        }
    }
